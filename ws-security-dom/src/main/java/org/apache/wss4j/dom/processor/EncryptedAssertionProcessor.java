...
public class EncryptedAssertionProcessor implements Processor {
    ...
    public List<WSSecurityEngineResult> handleToken(
        ...
        List<WSSecurityEngineResult> completeResults = new LinkedList<WSSecurityEngineResult>();
            ...
            for (WSSecurityEngineResult r : completeResults) {
                ...
                if (dataRefs != null) {
                    for (WSDataRef dataRef : dataRefs) {
                        if (WSSecurityEngine.SAML_TOKEN.equals(dataRef.getName())
                            || WSSecurityEngine.SAML2_TOKEN.equals(dataRef.getName())) {
