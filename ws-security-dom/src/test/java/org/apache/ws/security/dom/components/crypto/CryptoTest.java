...
package org.apache.ws.security.dom.components.crypto;
...
import org.apache.ws.security.dom.common.CustomCrypto;
...
public class CryptoTest extends org.junit.Assert {
    ...
    public void testCustomCrypto() throws Exception {
        ...
        Crypto crypto = CryptoFactory.getInstance(
            org.apache.ws.security.dom.common.CustomCrypto.class,
            tmp
        );
