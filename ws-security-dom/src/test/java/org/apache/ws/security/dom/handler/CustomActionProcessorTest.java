...
import org.apache.ws.security.dom.common.CustomAction;
import org.apache.ws.security.dom.common.CustomHandler;
import org.apache.ws.security.dom.common.CustomProcessor;
...
public class CustomActionProcessorTest extends org.junit.Assert {
    ...
    testCustomUserProcessor() throws Exception {
        ...
        String p = "org.apache.ws.security.dom.common.CustomProcessor";
        cfg.setProcessor(
            WSSecurityEngine.SIGNATURE,
            org.apache.ws.security.dom.common.CustomProcessor.class
        );
    ...
    testCustomAction() throws Exception {
        ...
        cfg.setAction(action, org.apache.ws.security.dom.common.CustomAction.class);
    ...
    testDecodeCustomAction() throws Exception {
        ...
        //
        cfg.setAction(customAction, org.apache.ws.security.dom.common.CustomAction.class);
