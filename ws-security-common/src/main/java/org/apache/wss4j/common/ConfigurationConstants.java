...
public class ConfigurationConstants {
    ...
    /**
     * Defines the Agreement method to derive encryption key to use to encrypt the generated symmetric key.
     * The default algorithm is:
     ...
     * The application may set this parameter using the following method:
     * <pre>
     *     call.setProperty(ConfigurationConstants.ENC_KEY_AGREEMENT_METHOD, WSConstants.AGREEMENT_METHOD_ECDH_ES);
     * </pre>
     *
     */
