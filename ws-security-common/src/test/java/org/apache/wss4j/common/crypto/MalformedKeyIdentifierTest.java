...
public class MalformedKeyIdentifierTest {
    ...
    public void testMerlinAKISkipsTruststoreEntryWithMalformedSubjectKeyIdentifier() throws Exception {
        ...
        trustStore.setCertificateEntry("malformed-ski", decode(MALFORMED_SKI_CERT, "2.5.29.14"));
    ...
    /**
     * Writing an SKI key identifier for a certificate we cannot decode must fail with a
     * WSSecurityException rather than an unchecked exception.
     */
    @Test
    public void testDOMX509SKIRejectsMalformedSubjectKeyIdentifier() throws Exception {
        ...
        assertThrows(WSSecurityException.class, () -> new DOMX509SKI(doc, cert));
    }
