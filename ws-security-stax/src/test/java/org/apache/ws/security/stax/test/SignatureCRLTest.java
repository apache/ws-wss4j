...
public class SignatureCRLTest extends AbstractTestBase {
    ...
    protected Map<String, Object> doOutboundSecurityWithWSS4J_1(
        ...
        sigProperties.setProperty("org.apache.ws.security.crypto.merlin.keystore.file", "wss40rev.jks");
        sigProperties.setProperty("org.apache.ws.security.crypto.merlin.keystore.password", "security");
        sigProperties.setProperty("org.apache.ws.security.crypto.merlin.keystore.alias", "wss40rev");
        sigProperties.setProperty("org.apache.ws.security.crypto.merlin.x509crl.file", "wss40CACRL.pem");
