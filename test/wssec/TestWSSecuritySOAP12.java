 ...
 */
public class TestWSSecuritySOAP12 extends TestCase {
    private static Log log = LogFactory.getLog(TestWSSecuritySOAP12.class);
     ...
     */
    public TestWSSecuritySOAP12(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        return new TestSuite(TestWSSecuritySOAP12.class);
    }
