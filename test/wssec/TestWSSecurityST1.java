 ...
 */
public class TestWSSecurityST1 extends TestCase implements CallbackHandler {
    private static Log log = LogFactory.getLog(TestWSSecurityST1.class);
    ...
    public static Test suite() {
        return new TestSuite(TestWSSecurityST1.class);
    }
