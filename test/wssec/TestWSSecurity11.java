 ...
 */
public class TestWSSecurity11 extends TestCase {
    private static Log log = LogFactory.getLog(TestWSSecurity11.class);
    ...
    public static Test suite() {
        return new TestSuite(TestWSSecurity11.class);
    }
