 ...
 */
public class TestWSSecurity5 extends TestCase implements CallbackHandler {
    private static Log log = LogFactory.getLog(TestWSSecurity5.class);
     ...
     */
    public TestWSSecurity5(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        return new TestSuite(TestWSSecurity5.class);
    }
