 ...
 */
public class TestWSSecurityST2 extends TestCase implements CallbackHandler {
    private static Log log = LogFactory.getLog(TestWSSecurityST2.class);
     ...
     */
    public TestWSSecurityST2(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        return new TestSuite(TestWSSecurityST2.class);
    }
