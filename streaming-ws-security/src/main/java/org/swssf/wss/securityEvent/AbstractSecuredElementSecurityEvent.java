...
public abstract class AbstractSecuredElementSecurityEvent extends AbstractElementSecurityEvent {
    ...
    public AbstractSecuredElementSecurityEvent(Event securityEventType, SecurityToken securityToken, List<XMLSecurityConstants.ContentType> protectionOrder) {
        this(securityEventType, securityToken, protectionOrder, false, false);
    }

    public AbstractSecuredElementSecurityEvent(Event securityEventType, SecurityToken securityToken, List<XMLSecurityConstants.ContentType> protectionOrder, boolean signed, boolean encrypted) {
