    ...
    public void testInboundPW_TEXT() throws Exception {
        ...
        //done UsernameToken; now verification:
        {
            ...
            try {
                ...
                Assert.assertEquals(e.getMessage(), "org.apache.ws.security.wss.ext.WSSecurityException: Wrong username");
            }
        }
    }
    ...
    */
    ...
    public void testReusedNonce() throws Exception {
        ...
        try {
            ...
            Assert.assertEquals(e.getMessage(), "org.apache.ws.security.wss.ext.WSSecurityException: The security token could not be authenticated or authorized");
        }
    }
