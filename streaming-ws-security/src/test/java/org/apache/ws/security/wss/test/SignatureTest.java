...
public class SignatureTest extends AbstractTestBase {
    ...
    public void testSignatureKeyIdentifierBinarySecurityTokenDirectReferenceOutbound() throws Exception {
        ...
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        {
            ...
            securityProperties.setCallbackHandler(new org.apache.ws.security.wss.test.CallbackHandlerImpl());
    ...
    public void testSignatureHMACOutputLengthInbound() throws Exception {
        ...
        //done signature; now test sig-verification:
        {
            ...
            try {
                ...
                Assert.assertEquals(e.getMessage(), "org.apache.ws.security.wss.ext.WSSecurityException: An error was discovered processing the <wsse:Security> header; nested exception is: \n" +
