 ...
 */
public class Canonicalizer11_OmitCommentsTransformer extends CanonicalizerBase {
     ...
     */
    public Canonicalizer11_OmitCommentsTransformer(String inclusiveNamespaces) {
