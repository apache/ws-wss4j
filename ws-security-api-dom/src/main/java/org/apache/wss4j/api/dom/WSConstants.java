...
public final class WSConstants extends WSS4JConstants {
    ...
    /**
     * Sets the {@link
     * org.apache.wss4j.api.dom.message.WSSecSignature#build(Document, Crypto, WSSecHeader)
    ...
    /**
     *Sets the {@link org.apache.wss4j.api.dom.message.WSSecSignature#build(Crypto)}
